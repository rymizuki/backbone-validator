describe('Backbone.Validator.Result', function () {
    describe('constraction', function () {
        var result = new Backbone.Validator.Result({
            "rules": { "name": ["required"] }
        });
    ...
    describe('result.get_errors', function () {
        ...
        describe('2 row setted', function () {
            ...
            result.set_error('required', 'name', undefined);
            result.set_error('length', 'name', undefined);
    ...
    describe('result.get_error', function () {
        describe('not setted', function () {
            ...
            it('retuned undefined', function () {
                expect(result.get_error('name', 'required')).to.be.eql(undefined);
            });
        });
        ...
        describe('setted', function () {
            ...
            result.set_error('required', 'name', undefined);
            result.set_error('length', 'length', 'aaaaaaaaaaaaaaa');
            ...
            it('getted falure', function () {
                expect(result.get_error('name', 'length')).to.be.eql(undefined);
            });
        });
    });
});
